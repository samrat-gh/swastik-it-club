      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mb-10">
          ...
          <p className="text-muted-foreground mb-4">
            The annual Swastik College Sports Week is a celebration of athletic
            excellence, teamwork, and sportsmanship. Students from all
            departments come together to compete in various sports disciplines,
            showcasing their talents and building lasting friendships. The event
            promotes physical fitness, mental well-being, and a healthy
            competitive spirit.
          </p>
          ...
          <div className="overflow-hidden rounded-lg border">
            <table className="divide-border min-w-full divide-y">
              ...
              <tbody className="bg-card divide-border divide-y">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">April 2, 2025</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">Cricket Field</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">April 3, 2025</td>
                  <td className="px-6 py-4 whitespace-nowrap">9:00 AM</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">April 4, 2025</td>
                  <td className="px-6 py-4 whitespace-nowrap">9:00 AM</td>
                  <td className="px-6 py-4">Basketball & Volleyball</td>
                  <td className="px-6 py-4 whitespace-nowrap">Indoor Courts</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">April 5, 2025</td>
                  <td className="px-6 py-4 whitespace-nowrap">9:00 AM</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">April 8, 2025</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">April 9, 2025</td>
